...
void load_style_mje()
{
   ...
   delete gROOT->GetStyle("mje");

   TStyle *tmpStyle = new TStyle("mje", "Matt's Style");
   ...
   tmpStyle->SetTickLength(0.01, "x");
   tmpStyle->SetTickLength(0.01, "y");
   tmpStyle->SetTickLength(0.01, "z");
